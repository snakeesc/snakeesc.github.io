...
function applyBuff(type, frog, durationMultiplier = 1) {
  ...
  function ensureHowToOverlay() {
    ...
    const root = document.getElementById("frog-game") || document.body;
    ...
    subtitle.textContent =
      "Move your frogs with the mouse, dodge snakes, collect orbs, and stack ridiculous buffs.";
    ...
    liOrbs.textContent = "Grab orbs to power up and unlock upgrades.";

    const liSnakes = document.createElement("li");
    liSnakes.textContent = "Touch a snake and that frog is gone for good.";

    const liBuffs = document.createElement("li");
    liBuffs.textContent =
      "Between waves, pick upgrades and permanent buffs to shape your run.";

    list.append(liMove, liOrbs, liSnakes, liBuffs);

    const footer = document.createElement("p");
    footer.className = "frog-howto-footer";
    footer.textContent =
      "Tip: bigger buff chains mean more chaos — in a good way.";
    ...
    playBtn.addEventListener("click", () => {
      try {
        if (typeof playButtonClick === "function") {
          playButtonClick();
        }
      } catch (_) {}
      hideHowToOverlay();
      if (typeof startGameFromHowTo === "function") {
        startGameFromHowTo();
      }
    });
