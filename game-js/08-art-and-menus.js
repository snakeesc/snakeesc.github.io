...
(()=>{
 const descriptions={
 'Royal Apprenticeship':'Eligible crowned frogs gain a special role now and whenever a special frog spawns. Each conversion gives them the same role; existing special frogs keep theirs. Not offered at the start of a run.',
