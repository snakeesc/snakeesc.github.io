...
(()=>{
 const css=document.createElement('link');css.rel='stylesheet';css.href='game-css/approved-menus.css?v=pause-columns-guide-back-12';document.head.appendChild(css);
