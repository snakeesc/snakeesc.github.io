...
(()=>{
 ...
 document.head.appendChild(style);
 function polish(){
  document.querySelectorAll('#runPauseOverlay[data-view="guide"] .pause-guide-entries .pause-row, #runPauseOverlay[data-view="run"] .pause-upgrade-grid .pause-row').forEach(row=>{
