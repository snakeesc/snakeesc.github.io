...
(function () {
  ...
  const config = {
    ...
    ORB_RADIUS: 12,
    ORB_TTL: 22,
    ORB_SPAWN_INTERVAL_MIN: 2.85,
    ORB_SPAWN_INTERVAL_MAX: 6.65,
    ...
    MIN_TOTAL_FROG_SPEED_FACTOR: 0.70,
    MAX_TOTAL_FROG_JUMP_FACTOR: 2.00,
